...
class Pix2PixHDModel(BaseModel):
    ...
    def forward(self, seg_map, target, seg_mask, infer=False):
        ...
        print("++++++++++++++++++++","seg_map",seg_map.shape,"target",target.shape,"seg_mask",seg_mask.shape,"end")

        app_feature_map = torch.zeros((1, 30, 256, 192)).float().cuda()
        ...
        # Gan Input
        print("*****************************",seg_map.shape,app_feature_map.shape)
